...
static void run(){
 ...
 char schema[] = "http";
    ...
    char buffer[] = "#EXTM3U \n"
                    ...
                    "# variants \n"
                    "#EXT-X-VERSION:3 \n"
                    "#EXT-X-STREAM-INF:BANDWIDTH=795000,AVERAGE-BANDWIDTH=723000,CODECS=\"mp4a.40.2,avc1.4D001E\",RESOLUTION=640x360,FRAME-RATE=25.0 \n"
                    "158-audio_133600_eng=131600-video=556400.m3u8\n"
                    "#EXT-X-STREAM-INF:BANDWIDTH=2190000,AVERAGE-BANDWIDTH=1991000,CODECS=\"mp4a.40.2,avc1.4D0028\",RESOLUTION=1920x1080,FRAME-RATE=25.0 \n"
                    "158-audio_133600_eng=131600-video=1752000.m3u8\n"
                    "#EXT-X-STREAM-INF:BANDWIDTH=6157000,AVERAGE-BANDWIDTH=5597000,CODECS=\"mp4a.40.2,avc1.640028\",RESOLUTION=1920x1080,FRAME-RATE=25.0 \n"
...
TSRemapDoRemap(void *ih, TSHttpTxn txnp, TSRemapRequestInfo *rri)
{
  ...
  for (int i = 0; i < cfg->paramNum; i++) {
    ...
    int paramLength = strlen(cfg->hash_query_param[i]);
